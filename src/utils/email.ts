...
export const sendVerifyRegisterEmail = (
  ...
  return sendVerifyEmail(
    ...
    template
      ...
      .replace('{{link}}', `${process.env.CLIENT_BASE_URL}/email-verifications?token=${email_verify_token}`)
  )
}
...
export const sendForgotPasswordEmail = (
  ...
  return sendVerifyEmail(
    ...
    template
      ...
      .replace('{{link}}', `${process.env.CLIENT_BASE_URL}/forgot-password?token=${forgot_password_token}`)
  )
}
